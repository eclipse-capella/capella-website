                    ...
                    <div class="col-md-12 text-center">
                        <div class="block wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <h2 class="wow fadeInUp animated" data-wow-delay=".6s" >
								Behind the Capella project there are MBSE experts<br>who will be pleased to answer to your questions</h2>
                        </div>
                    </div>
                </div>
            </div>
                	...
                	<div class="col-sm-6 col-xs-12 wow fadeInLeft animated">
						<p><img src="images/icons/icon_forum.png" alt="Capella Community" ></a></p>
                            <div>
                                ...
                                <p><a href="https://polarsys.org/forums/index.php/t/10/" target="_blank">Forum <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a></p>
